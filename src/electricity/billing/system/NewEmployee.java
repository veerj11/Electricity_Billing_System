...
public class NewEmployee extends JFrame implements ActionListener {
    ...
    NewEmployee(){
        ...
        JLabel heading = new JLabel("New Employee");
        ...
        JLabel lblmeterno = new JLabel("Employee Id");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            if (city.isEmpty()) {
                JOptionPane.showMessageDialog(null, "City must not be empty.");
                return;
            }
            
            if (state.isEmpty()) {
                JOptionPane.showMessageDialog(null, "State must not be empty.");
                return;
            }
            ...
            if (phone.isEmpty() || phone.length() != 10) {
                JOptionPane.showMessageDialog(null, "Phone number must be 10 characters long.");
                return;
            }
          
            
            String query1 = "insert into employee values('"+name+"', '"+meter+"', '"+address+"', '"+city+"', '"+state+"', '"+email+"', '"+phone+"')";
