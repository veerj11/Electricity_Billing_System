...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        JMenu masterEmp = new JMenu("Master Employee");
        masterEmp.setForeground(Color.BLUE);
        ...
        JMenuItem newcustomere = new JMenuItem("New Customer");
        newcustomer.setFont(new Font("monospaced", Font.PLAIN, 12));
        newcustomer.setBackground(Color.WHITE);
        ...
        newcustomere.setIcon(new ImageIcon(image14));
        newcustomere.setMnemonic('D');
        newcustomere.addActionListener(this);
        newcustomere.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, ActionEvent.CTRL_MASK));
        masterEmp.add(newcustomere);
        
        
        JMenuItem newemployee = new JMenuItem("New Employee");
        newemployee.setFont(new Font("monospaced", Font.PLAIN, 12));
        ...
        JMenuItem customerdetailse = new JMenuItem("Customer Details");
        customerdetailse.setFont(new Font("monospaced", Font.PLAIN, 12));
        customerdetailse.setBackground(Color.WHITE);
        ImageIcon icon15 = new ImageIcon(ClassLoader.getSystemResource("icon/icon2.png"));
        Image image15 = icon15.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        customerdetailse.setIcon(new ImageIcon(image15));
        customerdetailse.setMnemonic('M');
        customerdetailse.addActionListener(this);
        customerdetailse.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M, ActionEvent.CTRL_MASK));
        masterEmp.add(customerdetailse);
        ...
        JMenuItem depositdetailse = new JMenuItem("Deposit Details");
        depositdetailse.setFont(new Font("monospaced", Font.PLAIN, 12));
        depositdetailse.setBackground(Color.WHITE);
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("icon/icon3.png"));
        Image image16 = icon16.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        depositdetails.setIcon(new ImageIcon(image16));
        depositdetails.setMnemonic('N');
        depositdetails.addActionListener(this);
        depositdetails.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, ActionEvent.CTRL_MASK));
        masterEmp.add(depositdetailse);
        ...
        JMenuItem calculatebille = new JMenuItem("Calculate Bill");
        calculatebille.setFont(new Font("monospaced", Font.PLAIN, 12));
        calculatebille.setBackground(Color.WHITE);
        ImageIcon icon17 = new ImageIcon(ClassLoader.getSystemResource("icon/icon5.png"));
        Image image17 = icon17.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        calculatebille.setIcon(new ImageIcon(image17));
        calculatebille.setMnemonic('B');
        calculatebille.addActionListener(this);
        calculatebille.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, ActionEvent.CTRL_MASK));
        masterEmp.add(calculatebille);
